        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-life-bouy"></i> <span>KidzQui!</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-question-circle"></i> Questions <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Puzzles</a></li>
                      <li><a href="form_advanced.html">Games</a></li>
                      <li><a href="form_validation.html">Objective Type</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-child"></i> Students <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">Add New</a></li>
                      <li><a href="media_gallery.html">List Students</a></li>
                      <li><a href="typography.html">Edit Student Details</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-university"></i> Tutorials <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Add New</a></li>
                      <li><a href="tables_dynamic.html">Edit Tutorials</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
