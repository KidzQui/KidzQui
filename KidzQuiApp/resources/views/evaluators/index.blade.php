<!--
  ...
  * Purpose: shows the dashboard of the logged in evaluator
  * Date: 17-03-2017
  * Author: Gentelella
  * Integrator: R S DEVI PRASAD
  */
 -->
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <link href="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}" rel="stylesheet">
    <!-- JQVMap -->
    <link href="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/jqvmap/dist/jqvmap.min.css') }}" rel="stylesheet"/>
  ...
  <body class="nav-md">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('KidzQuiApp/public/bower_components/gentelella/production/images/img.jpg') }} " alt="">John Doe
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="{{ asset('KidzQuiApp/public/bower_components/gentelella/production/images/img.jpg') }}" alt="Profile Image" /></span>
                        <span>
    ...
    <!-- gauge.js -->
    <script src="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/gauge.js/dist/gauge.min.js') }}"></script>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Skycons -->
    <script src="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/skycons/skycons.js') }}"></script>
    <!-- Flot -->
    ...
    <!-- JQVMap -->
    <script src="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/jqvmap/dist/jquery.vmap.js') }}"></script>
    <script src="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('KidzQuiApp/public/bower_components/gentelella/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') }}"></script>
    <!-- bootstrap-daterangepicker -->
