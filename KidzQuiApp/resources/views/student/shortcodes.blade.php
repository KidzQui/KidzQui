					...
					<!-- Brand and toggle get grouped for better mobile display -->
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="shortcodes" class="active">Short Codes</a></li>
					...
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="dropdown">
							...
							<ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
								<li><a href="#dropdown1" tabstudenthome="-1" role="tab" id="dropdown1-tab" data-toggle="tab" aria-controls="dropdown1">@fat</a></li>
								<li><a href="#dropdown2" tabstudenthome="-1" role="tab" id="dropdown2-tab" data-toggle="tab" aria-controls="dropdown2">@mdo</a></li>
							</ul>
						</li>
					</ul>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-3 footer-left wow fadeInLeft animated" data-wow-delay=".5s">
				<h4>Features</h4>
				<ul>
					<li><a href="singlepage">Sed diam eu</a></li>
					<li><a href="singlepage">Ismod tincidunt </a></li>
					<li><a href="singlepage">Tincidunt ut </a></li>
				</ul>
			</div>
